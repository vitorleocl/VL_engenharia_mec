        ...
        tipos: [
          {
            ...
            checklistInicial: [
              { campo: "Fabricante da máquina", tipoResposta: "informacao", criterioReferencia: "Dado cadastral de placa/equipamento" },
              { campo: "Modelo da máquina", tipoResposta: "informacao", criterioReferencia: "Identificação comercial do modelo" },
              { campo: "Nº de série", tipoResposta: "informacao", criterioReferencia: "Número de série gravado na máquina" },
              { campo: "Ano de fabricação", tipoResposta: "data", criterioReferencia: "Ano constante na plaqueta ou nota fiscal" },
              { campo: "Manual de instruções do fabricante disponível?", tipoResposta: "sim_nao", criterioReferencia: "NR-12 item 12.11" },
              { campo: "Placa de identificação legível e fixada corretamente", tipoResposta: "conformidade", fotoObrigatoria: true, obrigatorioFoto: true, criterioReferencia: "NR-12 item 12.1.7 (Indelével e visível)" },
              { campo: "Horímetro atual no momento da inspeção", tipoResposta: "medida", unidade: "h", valorMinimo: 0, criterioReferencia: "Horas de operação acumuladas" },
              { campo: "Nível de ruído medido, quando aplicável", tipoResposta: "medida", unidade: "dB(A)", valorMinimo: 40, valorMaximo: 85, criterioReferencia: "NR-15 Anexo 1 (Limite de tolerância 85 dB(A) para 8h)" },
              { campo: "Nível de vibração medido, quando aplicável", tipoResposta: "medida", unidade: "m/s²", valorMinimo: 0, valorMaximo: 2.5, criterioReferencia: "NR-15 Anexo 8 (Limites normativos VMB e VCI)" },
              { campo: "PGR/PPRA da empresa correlacionado a esta apreciação", tipoResposta: "sim_nao", criterioReferencia: "NR-01 Gerenciamento de Riscos Ocupacionais" }
            ],
            secoesPadrao: [
            ...
            checklistPadrao: [
              { id: 'ck-nr12-1', descricao: 'Fabricante da máquina', tipoResposta: 'informacao', status: 'conforme', observacao: '' },
              { id: 'ck-nr12-2', descricao: 'Modelo da máquina', tipoResposta: 'informacao', status: 'conforme', observacao: '' },
              { id: 'ck-nr12-3', descricao: 'Nº de série', tipoResposta: 'informacao', status: 'conforme', observacao: '' },
              { id: 'ck-nr12-4', descricao: 'Ano de fabricação', tipoResposta: 'data', status: 'conforme', observacao: '' },
              { id: 'ck-nr12-5', descricao: 'Manual de instruções do fabricante disponível?', tipoResposta: 'sim_nao', status: 'conforme', observacao: '' },
              { id: 'ck-nr12-6', descricao: 'Placa de identificação legível e fixada corretamente', tipoResposta: 'conformidade', fotoObrigatoria: true, obrigatorioFoto: true, status: 'conforme', observacao: '' },
              { id: 'ck-nr12-7', descricao: 'Horímetro atual no momento da inspeção', tipoResposta: 'medida', unidade: 'h', valorMinimo: 0, status: 'conforme', observacao: '' },
              { id: 'ck-nr12-8', descricao: 'Nível de ruído medido, quando aplicável', tipoResposta: 'medida', unidade: 'dB(A)', valorMinimo: 40, valorMaximo: 85, status: 'conforme', observacao: '' },
              { id: 'ck-nr12-9', descricao: 'Nível de vibração medido, quando aplicável', tipoResposta: 'medida', unidade: 'm/s²', valorMinimo: 0, valorMaximo: 2.5, status: 'conforme', observacao: '' },
              { id: 'ck-nr12-10', descricao: 'PGR/PPRA da empresa correlacionado a esta apreciação', tipoResposta: 'sim_nao', status: 'conforme', observacao: '' }
            ]
          },
          {
